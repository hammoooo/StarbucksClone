...
struct OrderSheetView: View {
    ...
    @State private var destinationRouteCoordinates: [CLLocationCoordinate2D] = [
        CLLocationCoordinate2D(latitude: 37.5662952, longitude: 126.9779451)
    ] //일단
    ...
    private var mapView: some View {
        ZStack(alignment: .top) {
            MapView(region: $viewModel.region, stores: viewModel.filteredStores,routeCoordinates: destinationRouteCoordinates)
